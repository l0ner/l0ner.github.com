...
I've begun googling around and "discovered that I still can configure my touchpad through the xinput tool":http://askubuntu.com/questions/18576/vostro-3400-touchpad-multiple-gesture-and-two-finger-scrolling-not-working. Yeah! I quickly applied what I was doing in Arch through X11 config file, only to discover that it didn't fixed my issue.
