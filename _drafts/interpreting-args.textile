...
Nice and simple, but the situation complicated itself if we need to specify manually how many times the string should be printed and we want to provide  the usage instructions if -h or --help switch is specified. How do we do that?
