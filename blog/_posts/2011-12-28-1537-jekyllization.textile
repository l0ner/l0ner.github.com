...
The whole site isn't really finished yet. I need to create template files for the photoblog section, I need to do some fine-tuning on how the comtent looks like. I need to understand how to get the code highlight working with textile files. The correct syntax should be:
@{% highlight ruby linenos %}@
@def foo@
@  puts 'foo'@
@end@
@{% endhighlight %}@
And yet it doesn't work. The second @%@ in the first line gets interpreted as textile escape character and converted into @<span>@ html tag. I looked and "Tom Preston-Werner site":http://tom.preston-werner.com/ source "code":https://github.com/mojombo/mojombo.github.com amnd for him it works like it should.
